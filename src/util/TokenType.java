...
public enum TokenType {
    ...
    RESERVED_WORD_LET, RESERVED_WORD_MUT, RESERVED_WORD_READ, RESERVED_WORD_PRINT, RESERVED_WORD_IF, RESERVED_WORD_WHILE, RESERVED_WORD_INT, RESERVED_WORD_FLOAT, SEMICOLON, TWOPOINTS, LEFT_BRACE, RIGHT_BRACE;
}
